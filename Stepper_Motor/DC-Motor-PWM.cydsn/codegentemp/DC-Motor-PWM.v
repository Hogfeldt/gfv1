...
module top ;
	...
	wire [0:0] tmpOE__Pin_2_a_net;
	wire [0:0] tmpFB_0__Pin_2_a_net;
	wire [0:0] tmpIO_0__Pin_2_a_net;
	wire [0:0] tmpINTERRUPT_0__Pin_2_a_net;
	electrical [0:0] tmpSIOVREF__Pin_2_a_net;

	cy_psoc3_pins_v1_10
		#(.id("56bdf9a9-0baa-4ec3-aa2f-c8aca44a52f6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_2_a
		 (.oe(tmpOE__Pin_2_a_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_2_a_net[0:0]}),
		  .io({tmpIO_0__Pin_2_a_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_2_a_net),
		  .interrupt({tmpINTERRUPT_0__Pin_2_a_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_2_a_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_1_a_net;
	wire [0:0] tmpFB_0__Pin_1_a_net;
	wire [0:0] tmpIO_0__Pin_1_a_net;
	wire [0:0] tmpINTERRUPT_0__Pin_1_a_net;
	electrical [0:0] tmpSIOVREF__Pin_1_a_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_1_a
		 (.oe(tmpOE__Pin_1_a_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_1_a_net[0:0]}),
		  .io({tmpIO_0__Pin_1_a_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_1_a_net),
		  .interrupt({tmpINTERRUPT_0__Pin_1_a_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_1_a_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_1_b_net;
	wire [0:0] tmpFB_0__Pin_1_b_net;
	wire [0:0] tmpIO_0__Pin_1_b_net;
	wire [0:0] tmpINTERRUPT_0__Pin_1_b_net;
	electrical [0:0] tmpSIOVREF__Pin_1_b_net;

	cy_psoc3_pins_v1_10
		#(.id("4d7317e4-fd88-45b3-ac4e-35f8137efc9f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_1_b
		 (.oe(tmpOE__Pin_1_b_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_1_b_net[0:0]}),
		  .io({tmpIO_0__Pin_1_b_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_1_b_net),
		  .interrupt({tmpINTERRUPT_0__Pin_1_b_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_1_b_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_2_b_net;
	wire [0:0] tmpFB_0__Pin_2_b_net;
	wire [0:0] tmpIO_0__Pin_2_b_net;
	wire [0:0] tmpINTERRUPT_0__Pin_2_b_net;
	electrical [0:0] tmpSIOVREF__Pin_2_b_net;

	cy_psoc3_pins_v1_10
		#(.id("5a1c1227-d7cf-4966-9444-9c141730ab95"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_2_b
		 (.oe(tmpOE__Pin_2_b_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_2_b_net[0:0]}),
		  .io({tmpIO_0__Pin_2_b_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_2_b_net),
		  .interrupt({tmpINTERRUPT_0__Pin_2_b_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_2_b_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
